...
from gaussian_mapping_unreal_novel import GaussianMapperUnrealNovel
...
def GaussianMappingUnrealTimeNovel(dataset, parameters, tracking_result_q):
    gaussian_mapper = GaussianMapperUnrealNovel(dataset, parameters)
